  ...
  try {
    ...
    let centers = await LearningCenter.findAll({
      attributes: [
        ...
        "regionId",
        "createdBy",
        [Sequelize.fn("AVG", Sequelize.col("comments.star")), "averageStars"],
      ],
      include: [
        {
          model: Comment,
          attributes: [], // Exclude individual comments to avoid group-by issues
        },
        {
          model: Branch,
        },
      ...
      group: ["learningCenter.id", "branches.id", "region.id"],
      order: [[Sequelize.literal("averageStars"), sort]],
      limit: take,
      offset,
      subQuery: false,
